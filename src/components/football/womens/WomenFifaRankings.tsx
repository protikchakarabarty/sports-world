...
import { useWomenFifaRankings } from '@/hooks/useWomenFootballData';
...
export function WomenFifaRankings() {
  const { t } = useLanguage();
  const [search, setSearch] = useState('');
  const [confFilter, setConfFilter] = useState<string>('all');

  const { data: result, isLoading, isError, refetch, isFetching } = useWomenFifaRankings();
  ...
  return (
    <Section
      title={t("FIFA Women's World Rankings", "ফিফা মহিলা বিশ্ব র্যাঙ্কিং")}
      subtitle={t("Official FIFA/Coca-Cola World Ranking for Women's National Teams", 'মহিলা জাতীয় দলের অফিসিয়াল ফিফা/কোকা-কোলা বিশ্ব র্যাঙ্কিং')}
      gradient="football"
    >
